...
#             my_list.append(tuple(input("Please enter a tuple to be added like 1,2 ").split(",")))
#         if datatype_choice == 5:
#             my_list.append(input("Please enter a list to be added like 1,2,3,4 ").split(","))
#         if datatype_choice == 6:
#             my_list.append(set(input("Please enter a set to be added like 1,2 ").split(",")))
...
#
#             # my_temp_dict = { elem[0] : elem[1] for elem in str_elem.split(":")}
#             # my_temp_dict = dict( (elem[0] , elem[1]) for elem in str_elem.split(":"))
#             # my_temp_dict = dict( tuple(elem) for elem in str_elem.split(":"))
#
#             #my_temp_tuple_list = str_elem.split(":")
#             # my_temp_dict = {}
#             # my_temp_dict[my_temp_tuple_list[0] ] = my_temp_tuple_list[1]
#
#     if len(my_list)==0:
#         raise list_empty_error
#
